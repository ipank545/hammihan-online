...
//		if ($_POST['login'] == $username && $_POST['password'] == $password && $password) {
			...
			header("location: " . '/newss/assets/imagemanager/index.php?type=im&page=index.html');
			die;
//		}
//                else
...
<!--$_REQUEST['return_url']=/newss/assets/imagemanager/index.php?type=im&page=index.html-->
<!--$_POST['return_url']=/newss/assets/imagemanager/index.php?type=im&page=index.html-->
<!--$_POST['login']='admin';-->